            ...
            <div class="flex lg:flex-nowrap flex-wrap items-center">
                ...
                <div class="navigation hs-collapse transition-all duration-300 lg:basis-auto basis-full grow hidden items-center justify-center lg:flex mx-auto overflow-hidden mt-6 lg:mt-0 nav-light"
                    ...
                    <ul class="navbar-nav flex-col lg:flex-row gap-y-2 flex lg:items-center justify-center"
                        id="navbar-navlist">
                        <li class="nav-item mx-1.5 transition-all text-dark lg:text-black group-[&.is-sticky]:text-dark all duration-300 hover:text-primary <?php echo activeClass('home', $page); ?>">
                            <a id="nav-home"
                        ...
                        <li class="nav-item mx-1.5 transition-all text-dark lg:text-black group-[&.is-sticky]:text-dark duration-300 hover:text-primary <?php echo activeClass('services', $page); ?>">
                            <a id="nav-services"
                                class="nav-link inline-flex items-center text-sm lg:text-base font-medium py-0.5 px-2 capitalize"
                                href="index.php?page=services&lang=<?php echo $lang; ?>"><?php echo $translations['navbar']['services']; ?></a>
                        </li>
                        <li class="nav-item mx-1.5 transition-all text-dark lg:text-black group-[&.is-sticky]:text-dark duration-300 hover:text-primary <?php echo activeClass('about', $page); ?>">
                            <a id="nav-about-us"
                                class="nav-link inline-flex items-center text-sm lg:text-base font-medium py-0.5 px-2 capitalize"
                                href="index.php?page=about&lang=<?php echo $lang; ?>"><?php echo $translations['navbar']['about_us']; ?></a>
                        </li>
                        <li class="nav-item mx-1.5 transition-all text-dark lg:text-black group-[&.is-sticky]:text-dark duration-300 hover:text-primary <?php echo activeClass('pricing', $page); ?>">
                            <a id="nav-pricing"
                                class="nav-link inline-flex items-center text-sm lg:text-base font-medium py-0.5 px-2 capitalize"
                                href="index.php?page=pricing&lang=<?php echo $lang; ?>"><?php echo $translations['navbar']['pricing']; ?></a>
                        </li>
                        <li class="nav-item mx-1.5 transition-all text-dark lg:text-black group-[&.is-sticky]:text-dark duration-300 hover:text-primary <?php echo activeClass('contact', $page); ?>">
                            <a id="nav-contact"
                                class="nav-link inline-flex items-center text-sm lg:text-base font-medium py-0.5 px-2 capitalize"
                ...
                <div class="ms-auto shrink hidden lg:inline-flex gap-2">
                    <a href="?lang=en" class="px-2 py-1 text-sm font-medium <?php echo $lang === 'en' ? 'bg-primary text-white' : 'text-gray-800'; ?>">EN</a>
                    <a href="?lang=fr" class="px-2 py-1 text-sm font-medium <?php echo $lang === 'fr' ? 'bg-primary text-white' : 'text-gray-800'; ?>">FR</a>
                    <a href="?lang=nl" class="px-2 py-1 text-sm font-medium <?php echo $lang === 'nl' ? 'bg-primary text-white' : 'text-gray-800'; ?>">NL</a>
                </div>
            </div>
        </div>
    </nav>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 pb-16 pt-16">
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="mt-6 grid space-y-3">
                            ...
                            <p><a class="inline-flex gap-x-2 text-base text-gray-300 hover:text-gray-400 transition-all duration-300"
                                    href="service.html">Services</a></p>
                            <p><a class="inline-flex gap-x-2 text-base text-gray-300 hover:text-gray-400 transition-all duration-300"
                    ...
                    <div class="col-span-1">
                        <img src="./assets/images/footer.png" alt="Footer funny Image"
                            class="h-48 w-full object-cover rounded-lg" loading="lazy">
                    </div>
